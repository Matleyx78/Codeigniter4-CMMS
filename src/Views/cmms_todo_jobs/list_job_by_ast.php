            ...
            <nav class="navbar navbar-default">
                <div class="container-fluid">
                    <div class="navbar-header">
                        <a class="navbar-brand" href="#">Elenco Lavori per <?php echo $asset['asst_description'];?></a>                            
                    </div>
                    <ul class="nav navbar-nav navbar-right">
                                <li><a href="<?php echo site_url('cmms_report/tdjb_by_asst/'.$asset['id_asst']) ?>"><span class="glyphicon glyphicon-print"></span> Stampa</a></li>
                    </ul>
                </div>
            </nav>
